(function() {
    ...
    function addStyles() {
        ...
        css.innerHTML = [
            ...
            '.ae-info { background: #f7fafc; border: 1px solid #E5E7EB; border-radius: 8px; padding: 24px; margin: 20px 0; }',
            '.ae-title { color: #111827; font-size: 1.25rem; font-weight: 600; margin-bottom: 16px; }',
            '#calendly-container { margin-top: 20px; border-radius: 12px; overflow: hidden; }'
        ].join('\n');
        document.head.appendChild(css);
    }

    function loadAEData() {
        console.log('Loading AE data...');
            ...
            if (xhr.readyState === 4 && xhr.status === 200) {
                Papa.parse(xhr.responseText, {
                    ...
                    complete: function(results) {
                        ...
                        console.log('Data loaded:', aeMapping);
                    }
                });
            }
        };
